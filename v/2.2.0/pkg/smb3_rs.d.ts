 ...
 */
export function validate_rom(rom: Uint8Array, skip_validation: boolean): string;
...
export interface InitOutput {
    ...
    readonly validate_rom: (a: number, b: number, c: number) => [number, number, number, number];
