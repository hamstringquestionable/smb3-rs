 ...
 * @returns {Uint8Array}
 */
export function apply_ips_patch(rom, patch) {
    ...
    const ret = wasm.apply_ips_patch(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function build_ips_patch(original, modified) {
    const ptr0 = passArray8ToWasm0(original, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(modified, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_ips_patch(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {number}
 */
export function current_flag_key_version() {
    const ret = wasm.current_flag_key_version();
    return ret;
}
 ...
 * @returns {string}
 */
export function decode_flag_key(key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decode_flag_key(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function flag_key_fields_json() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.flag_key_fields_json();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {number}
 */
export function flag_key_version_of(key) {
    const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.flag_key_version_of(ptr0, len0);
    if (ret[2]) {
 ...
 * @param {bigint} seed
 * @param {string} options_json
 * @param {Uint8Array | null} [visual_patch]
 * @returns {Uint8Array}
 */
export function generate_patch(rom, seed, options_json, visual_patch) {
    const ptr0 = passArray8ToWasm0(rom, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(visual_patch) ? 0 : passArray8ToWasm0(visual_patch, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.generate_patch(ptr0, len0, seed, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Uint8Array}
 */
export function generate_patched_rom(rom, seed, options_json, visual_patch) {
    const ptr0 = passArray8ToWasm0(rom, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(visual_patch) ? 0 : passArray8ToWasm0(visual_patch, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.generate_patched_rom(ptr0, len0, seed, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {string}
 */
export function seed_hash_json(rom, seed, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(rom, wasm.__wbindgen_malloc);
        ...
        const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.seed_hash_json(ptr0, len0, seed, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 */
export function validate_rom(rom, skip_validation) {
    const ptr0 = passArray8ToWasm0(rom, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_rom(ptr0, len0, skip_validation);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('smb3_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
