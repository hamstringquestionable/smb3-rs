...
export const SCHEMA = [
	...
	{ id: "wild_injections", type: "toggles", options: WILD_INJECTION_TOGGLES,
		...
		icon: BOSS_BASS,
		group: "enemies", inFlagKey: true },
	{ id: "lakitu_stays_dead", type: "bool", default: false,
		label: "Lakitu Stays Dead",
		tip: "Beat a Lakitu and it's gone for good, instead of drifting back in a few seconds later.",
		group: "enemies", inFlagKey: true },
