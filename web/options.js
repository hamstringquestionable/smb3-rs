...
export const GROUPS = [
	...
	{ id: "starting-items", label: "Starting Items", note: "Choose up to 3 items to start with in your inventory." },
];
...
export const SCHEMA = [
	// --- ROM section (rendered into a separate host above the fieldsets) ---
	{
		...
		tip: "Skip the SMB3 (USA) header/size checks so modded or translated ROMs can be loaded. The racing hash on the title screen will be disabled, since its hooks assume the vanilla ROM layout.",
	...
	{ id: "powerups", type: "bool", default: true,
		...
		group: "randomization", inFlagKey: true },
	{ id: "palettes", type: "bool", default: true,
		label: "Palettes",
		tip: "Randomize character, lava, and Bowser color palettes (cosmetic — does not affect seed or flag key)",
		group: "randomization", inFlagKey: false },
	{ id: "palette_themed", type: "bool", default: false,
		label: "Themed per-tileset",
		tip: "Also randomize per-tileset BG/enemy palettes using curated 4-byte variants from Super Mario Bros. 3 Recolored. Independent of seed; re-roll freely.",
		group: "randomization", inFlagKey: false,
	...
	{ id: "shell", type: "tri", options: TRI, default: "shuffle",
		label: "Shell",
		tip: "Shell-producing enemies (Koopa, Buzzy Beetle, etc.)",
		group: "enemies", inFlagKey: true },
	{ id: "flying", type: "tri", options: TRI, default: "shuffle",
		label: "Flying",
		tip: "Flying/hopping enemies (Paratroopa, Paragoomba, etc.)",
		group: "enemies", inFlagKey: true },
	{ id: "bullet_bills", type: "tri", options: TRI, default: "shuffle",
		label: "Bullet Bills",
		tip: "Bullet Bill variants — standard and homing",
		group: "enemies", inFlagKey: true },
	...
	{ id: "cannons", type: "tri", options: TRI, default: "off",
		label: "Cannons",
		tip: "Cannon fire directions and types",
		group: "enemies", inFlagKey: true },
	...
	{ id: "bros", type: "tri", options: TRI, default: "shuffle",
		label: "Bros",
		tip: "Hammer/Boomerang/Fire Bros (only in non-HB segments)",
		group: "enemies", inFlagKey: true },
	{ id: "hb_encounters", type: "tri", options: TRI, default: "off",
		label: "HB Encounters",
		tip: "All enemies in Hammer Bro encounter segments",
		group: "enemies", inFlagKey: true },
	...
	// --- Overworld ---
	{ id: "map_shuffle", type: "bool", default: true,
		label: "Map Shuffle",
		tip: "Rebuild the overworld — new tile positions, locks, and fortresses. Disables Level Shuffle.",
		group: "overworld", inFlagKey: true },
	{ id: "shuffle_pipes", type: "bool", default: true,
		label: "Pipe Shuffle",
		tip: "Shuffle pipe endpoint positions (only when Map Shuffle is on)",
		group: "overworld", inFlagKey: true,
		enabledWhen: { map_shuffle: true }, indent: true },
	{ id: "level_shuffle", type: "radio",
		options: [
			{ value: "off", label: "Off" },
			{ value: "intra_world", label: "Within World", desc: "levels stay in their world" },
			{ value: "cross_world", label: "Cross World", desc: "levels mix between worlds" },
		],
		default: "off",
		label: "Level Shuffle",
		tip: "How levels are reshuffled under the vanilla map layout (only when Map Shuffle is off)",
		group: "overworld", inFlagKey: true,
		enabledWhen: { map_shuffle: false }, indent: true },
	...
	{ id: "airship_lock", type: "bool", default: true,
		label: "Airship Lock",
		tip: "Airships stay in place after losing. Anchors become random power-ups instead.",
		group: "qol", inFlagKey: true },
	...
	{ id: "remove_n_cards", type: "bool", default: true,
		...
		group: "qol", inFlagKey: true },
	{ id: "remove_spade_games", type: "bool", default: true,
		label: "Remove Spade Games",
		tip: "Remove spade (card matching) games from the overworld, freeing map slots for levels",
		group: "qol", inFlagKey: true },
	...
	// --- Starting Items (one entry, three slots) ---
	{ id: "starting_items", type: "items",
		items: ITEM_OPTIONS, slots: 3,
		default: [],
		label: "Starting Items",
		group: "starting-items", inFlagKey: true },
];
...
export function renderOptions(rootEl, hosts = {}) {
	for (const group of GROUPS) {
		const fieldset = el("fieldset", { class: "section" });
